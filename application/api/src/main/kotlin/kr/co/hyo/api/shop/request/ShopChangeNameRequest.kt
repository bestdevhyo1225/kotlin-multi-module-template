...
data class ShopChangeNameRequest(
    ...
    @field:Schema(description = "매장 이름", example = "테스트-2", required = true)
    val name: String,
) {

    fun toSeviceDto(): ShopChangeNameDto =
        ShopChangeNameDto(serviceType = serviceType, id = id, name = name)
}
